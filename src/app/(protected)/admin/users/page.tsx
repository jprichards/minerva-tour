            ...
            <div key={user.id} className="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
              ...
              {editingUser === user.id ? (
                <div className="mt-3 space-y-3 border-t border-gray-100 pt-3">
                  ...
                  <div>
                    <label className="text-xs text-gray-500 font-medium">Handicap Index</label>
                    <input
                      type="number"
                      step="0.1"
                      min="0"
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center gap-1.5 bg-emerald-600 text-white rounded-lg px-3 py-2 text-sm font-medium"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 bg-gray-100 text-gray-600 rounded-lg px-3 py-2 text-sm font-medium"
                    >
                      Cancel
                    </button>
                  </div>
