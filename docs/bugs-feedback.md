...
- Glide Round History "Gross Score" column stores Projected Gross (not Actual Gross)
  for scores entered via direct gross entry. 797 scores across 2020-2025 affected.
...
- Import scripts computed net_strokes_over_par using course rating instead of par.
  736 scores across 2018-2026 had wrong NOP. Fix script: scripts/fix-nop-rating-vs-par.mjs.
